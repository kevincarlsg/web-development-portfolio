                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="school_id" name="school_id" class="form-select" {{ old('new_school_name') ? 'disabled' : '' }}>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="subject_id" name="subject_id" class="form-select" {{ old('new_subject_name') ? 'disabled' : '' }}>
